...
import com.erendogan6.aracimyanimda.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.erendogan6.aracimyanimda.databinding.ActivityMainBinding binding = ActivityMainBinding.inflate(this.getLayoutInflater()); // Bağlama nesnesini oluştur ve ActivityMainBinding sınıfından inflate et
